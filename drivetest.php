...
{
$result = mysqli_query($conn,"select * from  testdrive where bookingid='$_GET[testid]'");
 ...
 ?>   
          ...
          <form id="form1" name="form1" method="post" action="" onsubmit="return validate()">		
			...
			?>
			  ...
			  {
			  $res = mysqli_query($conn,"select vehname from vehiclestore where vehicleid='$_GET[vahicleidnum]'");
              ...
              <select name="vahicleid" id="bstatus3">
                <?php
				$sql = mysqli_query($conn,"select vehname,vehicleid from vehiclestore");
