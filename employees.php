...
if(isset($_GET['empid']))
{
$sql = mysqli_query($conn,"select * from  employee where employeeid='$_GET[empid]'");
		...
		<form id="form1" name="form1" method="post" action="" onsubmit="return validate()">
			<table width="371" border="0">
			  ...
			  <tr>
				...
				<input type="text" name="password" value="<?php echo $row['password']=''; ?>" id="password" /></td>
		      </tr>
			  <tr>
			    <th height="34" scope="row">Confirm Password</th>
				<td><label for="confpass"></label>
				<input type="text" name="confpass" value="<?php echo $row['confpass']=''; ?>" id="confpass" /></td>
		      </tr>
			  <tr>
