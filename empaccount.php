  ...
  <table width="539" border="1">
    <tr>
      ...
      <td width="141" align="center" valign="middle">
        <strong>
        <?php
$sqlcount = mysqli_query($conn,"select * from customer");
echo mysqli_num_rows($sqlcount);
?>
      </strong></td>
    </tr>
    <tr>
      ...
      <td align="center" valign="middle">
        <strong>
        <?php
$sqlcount = mysqli_query($conn,"select * from service where status='Pending'");
echo mysqli_num_rows($sqlcount);
?>
      </strong></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center" valign="middle">
		<strong>
		<?php
			$sqlcount = mysqli_query($conn,"select * from sparepartsorder where deliverydate='0000-00-00'");
			echo mysqli_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center" valign="middle"><strong>
        <?php
            $sqlcount = mysqli_query($conn,"select * from vehicle where status ='Pending'");
			echo mysqli_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
    <tr>
      ...
      <td align="center" valign="middle">
	    <strong>
	    <?php
           $sqlcount = mysqli_query($conn,"select * from vehiclestore where status !='Sold'");
			echo mysqli_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
    <tr>
      ...
      <td align="center" valign="middle"> <strong>
        <?php
           $sqlcount = mysqli_query($conn,"select * from testdrive where status ='Pending'");
			echo mysqli_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
