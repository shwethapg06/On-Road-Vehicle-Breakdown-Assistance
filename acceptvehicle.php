...
$sql1 = mysqli_query($conn,"update vehicle set status='Accepted' where sellno='$_GET[sellno]'");
}
...
{
$result = mysqli_query($conn,"select * from vehicle where sellno='$_GET[sellno]'");
