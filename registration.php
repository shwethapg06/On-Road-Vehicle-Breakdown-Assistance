...
{
$sql ="insert into customer(fname,lname,emailid ,password,createddate,contactno1,contactno2,address,city,zipcode) values('$_POST[fname]','$_POST[lname]','$_POST[emailid]','$_POST[password]','$dt','$_POST[phone]','$_POST[mobile]','$_POST[address]','$_POST[city]','$_POST[zipcode]')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: ' . mysqli_error());
  }
$ctins =  mysqli_affected_rows($conn);
}
?>		
		...
		<form id="form1" name="form1" method="post" action="" onsubmit="return validate()">		
			<table width="522" border="0">
			  ...
			  <tr>
		        ...
		        <input name="emailid" type="text" id="emailid" size="35" /></td>
		      </tr>
			  <tr>
